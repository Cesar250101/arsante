...
class UydAlimentos(models.Model):
    _name = 'arsante.uyd_alimentos'

    def _default_get(self):
        tipo_id = self.env['arsante.tipo_registro'].search([('tipo', '=', 'uyd_alimentos')])
        return tipo_id
    ...
    def create_so(self):
        ...
        ids = self.env["arsante.uyd_alimentos"].browse(self._context.get("active_ids", []))
