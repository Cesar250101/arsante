...
class RegistroISP(models.Model):
    _name = 'arsante.registro_isp'
    ...
    tipo_registro = fields.Selection([
        ('cda_cosmeticos', 'CDA Cosméticos - DM'),
        ('registro_cosmeticos', 'Registros Cosméticos'),
        ('modif_cosmeticos', 'Modificaciones Cosméticos - DM'),
        ('inscripciones', 'Inscripciones'),
        ('exim_cosmeticos_proceso', 'Exim. Cosméticos EN PROCESO'),
        ('rectificaciones', 'Rectificaciones'),
        ('cda_uyd_alimentos', 'CDA UYD Alimentos'),
        ('dispositivos_medicos', 'Dispositivos médicos'),
        ('exim_cosmeticos', 'Eximiciones Cosméticos'),
        ('renovaciones_cosmeticos', 'Renovaciones Cosméticas'),
        ('registro_desinfectantes', 'Registro desinfectantes'),
        ('modificaciones_desinfectantes', 'Modificaciones desinfectantes'),
        ('renovaciones_desinfectantes', 'Renovaciones Desinfectantes'),
    ...
    def create(self, vals):
        rec= super(RegistroISP,self).create(vals)
        try:
